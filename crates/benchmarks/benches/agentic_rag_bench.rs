...
use kias_knowledge::memory_layers::{
    DreamConfig, DreamConsolidator, SessionMemoryConfig, SessionMemoryEntry,
    SessionMemoryManager, ToolCallStats, ToolResultStore, ToolResultStoreConfig,
};
    ...
    c.bench_function("session_memory_update", |b| {
        b.iter(|| {
            rt.block_on(async {
                ...
                for i in 0..100 {
                    mgr.update("s1", &format!("finding {}", i), Some("doc1")).await;
                }
    ...
    c.bench_function("dream_consolidation", |b| {
        b.iter(|| {
            rt.block_on(async {
                ...
                for i in 0..10 {
                    consolidator.record_session(SessionMemoryEntry {
    ...
    c.bench_function("flywheel_recommend", |b| {
        b.iter(|| {
            rt.block_on(async {
                ...
                for i in 0..50 {
                    learner.record(RetrievalExperience {
