    ...
    pub fn sop_template() -> DocumentTemplate {
        DocumentTemplate {
            ...
            sections: vec![
                TemplateSection {
                    title: "目的".into(),
                    content: "描述本SOP的目的和适用范围".into(),
                    required: true,
                    order: 1,
                },
                TemplateSection {
                    title: "范围".into(),
                    content: "本SOP适用于...".into(),
                    required: true,
                    order: 2,
                },
                TemplateSection {
                    title: "职责".into(),
                    content: "列出相关人员职责".into(),
                    required: true,
                    order: 3,
                },
                TemplateSection {
    ...
    pub fn validation_protocol_template() -> DocumentTemplate {
        DocumentTemplate {
            ...
            sections: vec![
                ...
                TemplateSection {
                    title: "验证策略".into(),
                    content: "验证方法和接受标准".into(),
                    required: true,
                    order: 3,
                },
                TemplateSection {
                    title: "人员职责".into(),
                    content: "验证团队成员及职责".into(),
                    required: true,
                    order: 4,
                },
                TemplateSection {
                    title: "测试用例".into(),
                    content: "详细测试步骤和预期结果".into(),
                    required: true,
                    order: 5,
                },
                TemplateSection {
