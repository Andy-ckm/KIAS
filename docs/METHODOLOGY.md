...
L2: knowledge, team-engine, workflow-engine, ...
...
| 功能 | 参考项目 | 代码行数 |
|------|---------|---------|
| 认证中间件 | axum-login | 3937行 |
| 知识图谱可视化 | cytoscape.js / Antv G6 | - |
| 审计时间线 | vis-timeline | - |
| 合规仪表盘 | Grafana / Superset | - |
